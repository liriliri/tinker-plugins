export const tw = {
  ...
  border: {
    ...
    focus: 'focus:border-accent-500 dark:focus:border-accent-400',
  },
  badge: {
    active: 'bg-accent-500 dark:bg-accent-400 text-white dark:text-zinc-950',
    inactive: 'bg-zinc-200 dark:bg-zinc-700 text-zinc-500 dark:text-zinc-400',
  },
  copy: {
    idle: 'text-zinc-300 dark:text-zinc-600 hover:text-zinc-500 dark:hover:text-zinc-400 hover:bg-gray-100 dark:hover:bg-zinc-700',
    copied:
