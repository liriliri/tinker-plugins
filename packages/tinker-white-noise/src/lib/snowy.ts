import howlingWind from '../assets/howling-wind.m4a'

// https://www.shadertoy.com/view/ldsGDn
const shader = `// Copyright (c) 2013 Andrew Baldwin (twitter: baldand, www: http://thndl.com)
...
export default { audio: howlingWind, renderPass }
