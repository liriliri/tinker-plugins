import deepOcean from '../assets/deep-ocean.m4a'

// https://www.shadertoy.com/view/4sXBRn
const shader = `// Luminescence by Martijn Steinrucken aka BigWings - 2017
...
export default { audio: deepOcean, renderPass }
