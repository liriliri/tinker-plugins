import heavyRain from '../assets/heavy-rain.m4a'

// https://www.shadertoy.com/view/MdfBRX
const shader = `// "The Drive Home" by Martijn Steinrucken aka BigWings - 2017
...
export default { audio: heavyRain, renderPass }
