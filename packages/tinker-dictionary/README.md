...
A dictionary plugin for [TINKER](https://github.com/liriliri/tinker), supporting MDX and ZIP dictionary files for word lookup.

![Screenshot](https://raw.githubusercontent.com/liriliri/tinker-plugins/master/packages/tinker-dictionary/screenshot.png)
